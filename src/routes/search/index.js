		...
		return (
			<div className={style.search}>
				<div className={style.search_bar}>
					<p>
						Enter your location below and we'll show PVC wards close to you.
					</p>
						...
						<div className="field">
							<div className="control has-icons-right">
								<input
									...
									placeholder="Search Locations: Lekki, Badagry, Epe e.t.c"
								/>
				...
				<div className={searchRow}>
					<div className={style.suggest_location}>
						<a onClick={this.showsuggest()} href="#">
							Suggest a Location
						</a>
					</div>
									...
									{this.state.locations.map((item, i) => (
										<div className="column is-half">
											<div className={style.search_collection}>
												...
												<p>
													<strong>State</strong>: {item.state} State
												</p>
											</div>
											<footer class="card-footer">
												...
												<a
													onClick={this.showdeletion(item)}
													href="#"
													class="card-footer-item"
												>
													Suggest Deletion
					...
					<div className={disqusSection}>
						<div className={style.disqus_section__inner}>
							<div className={style.disqus_section__close}>
								<a onClick={this.closeDisqus()} href="#">
									X
								</a>
							</div>
							{this.state.currentLocation !== null && (
								<div className={style.disqus_section__content}>
									<p>
										<strong>{this.state.currentLocation.name}</strong>
									</p>
					...
					{this.state.currentLocation !== null && (
						<div>
							<div className={style.modal__header}>
								<strong>
									Suggest Edits for {this.state.currentLocation.name}
								</strong>
							</div>
							<p>
								<blockquote>
									We apologise for any wrong information you see. Please help us
									clean it up by making edits and suggestions. 😁
								</blockquote>
							</p>
							<div className={style.modal__body}>
								<form
									action="https://formspree.io/govoteng@gmail.com"
									method="POST"
								>
									<input
										type="hidden"
										name="_subject"
										value="Suggestion Edits for a Location"
									/>
									<input
										type="hidden"
										name="_next"
										value="https://govote.org.ng/#/search"
									/>
									<div className="field">
									...
									<div className="field">
										...
										<div class="control">
											<input
												...
												type="text"
												name="Address"
												value={this.state.currentLocation.address}
											/>
										</div>
									</div>
									<div className="field">
									...
									<div className="field">
										...
										<div class="control">
											<input
												...
												type="text"
												name="Area"
												value={this.state.currentLocation.area}
											/>
										</div>
									</div>
									<div className="field">
									...
									<div className="field">
										...
										<div class="control">
											<input
												...
												type="text"
												name="State"
												value={this.state.currentLocation.state}
											/>
										</div>
									</div>
									<div class="control">
				...
				>
					{this.state.currentLocation !== null && (
						<div>
							<div className={style.modal__header}>
								<strong>
									Suggest Deletion for {this.state.currentLocation.name}
								</strong>
							</div>
							<div className={style.modal__body}>
								<form
						...
						<div className={style.modal__body}>
							...
							>
								<input
									type="hidden"
									name="_subject"
									value="New Suggestion submission!"
								/>
								<input
									type="hidden"
									name="_next"
